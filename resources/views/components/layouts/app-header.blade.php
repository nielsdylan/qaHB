    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                ...
                <img src="{{ asset('images/logo/hb_group.png') }}" class="header-brand-img light-logo1" alt="logo" style=" width: 60px;background-color: #ffff;border-radius: 30px; ">
            </a>
            <!-- LOGO -->
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                ...
                                                data-bs-image-src="{{ asset('template/images/products/3.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/products/5.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/products/7.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/products/1.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/products/2.jpg') }}"></span>
                                            <div class="wd-50p">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                ...
                                                data-bs-image-src="{{ asset('template/images/users/1.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/users/15.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/users/12.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/users/4.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template/images/users/3.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
