...
@section('titulo')
HB GROUP - Gestion de Tipo de Documentos
@endsection
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="javascript:void(0)" class="btn btn-success btn-sm" id="nuevo" ><i class="fe fe-plus"></i> Nuevo Tipo de Documento</a>
                </div>
            </div>
            <div class="card-body">
...
@section('script')
    ...
    <script src="{{asset('components/configuraciones/tipo-documentos/tipo_documento-model.js')}}"></script>
